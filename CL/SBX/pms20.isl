	...
	If dbok
		...
		If (error="")
                    ...
                    if (aux<>"") 
                        fecha=aux
                    ELSE
                        ErrorMessage "PMS20: DiaDeNegocio: Fecha vacia"
                    endif	
		Else 	
                    
                    ErrorMessage "PMS20: DiaDeNegocio: Error al obtener sql"
                    ErrorMessage error
		Endif	
                call ODBCbaja
	Else
            ErrorMessage "PMS20: DiaDeNegocio: Error al conectar BD"
	Endif		
EndSub
//************************* BD ******************************
//Leo driver BD

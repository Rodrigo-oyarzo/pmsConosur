...
//*********************************************************************
//inq 5: Fixes Sodexo issue with the "charged tip" treated as "resto de ticket"
//*********************************************************************
Event Inq: 5 
    Var STATUS            			: N10 = 0
    Var EXTRA            			: A20 = ""
	...
	Window 4,75
	Display 1,10,"Ingrese el monto de Sodexo"
	Display 2,10,"Monto    :"
	DisplayMSInput 2,30,datos,"INGRESE Monto de Sodexo"
	WindowInput
	StrKey = Key(9, 210)
	LoadKybdMacro strKey,makekeys(DATOS),@KEY_ENTER,@KEY_ENTER
	If @TTLDUE < @TNDTTL 
		LoadKybdMacro @KEY_ENTER,@KEY_ENTER
	EndIf
EndEvent
...
//*********************************************************************
//inq 6: looks up the employee on a local file ..\scripts\empleados.TxT
//*********************************************************************
Event Inq: 6  
//    Var Archivo_Empleados      			: A30 = "..\scripts\empleados.TxT"
//    Var Archivo_Empleados                       : A80 = "\\Srvpos007\MICROS_APP\RES\CAL\WS4\Files\CF\Micros\scripts\empleados.TxT"
    Var Archivo_Empleados                       : A35 = "\CF\Micros\scripts\empleados.TxT"
	...
	Call ClearFile	// IPN 18 08 2016
	
    Fopen Fn02, Archivo_Empleados, Read
    Window 4,75
	Display 1,10,"NUMERO DE RUT DE EMPLEADO"
	Display 2,10,"NRO RUT    :"
	DisplayMSInput 2,30,rutABUSCAR,"INGRESE NRO DE RUT"
	WindowInput
	If Fn02 = 0
       Fopen Fn02, Archivo_Empleados, Read
      EndIf
    ...
    EndWhile
    If Feof(fn02)
    ErrorMessage " No esta en la base de datos!"
	EndIf
    Fclose Fn02
EndEvent
...
Event Inq:8
	...
	DisplayMSInput 2,26,nroemp,"Ingrese Nro de Emp"
	Display 2,6,"Numero de Empleado?"
	WindowInput     
	If nroemp="" 
		ErrorMessage "Nro. Empleado Invalido"
		//Return
	Else
		Call busca_emp2(nroemp, nome, cmax,totalact)
		Window 6,50
		Display 1,10,"* DATOS DEL EMPLEADO *"
		Display 2,6,"Nro Empleado :",nroemp
		Display 3,6,"Nombre       :",nome
	...
	If (key_pressed = @Key_Enter and nroemp <>"")
		Touchscreen @ALPHASCREEN
		Window 6,50
		DisplayMSInput 2,26,snuevomonto,"Ingrese Nuevo Monto Maximo Empleado"
		Display 2,6,"Nuevo monto?"
		WindowInput   
		Call creditupdate(nroemp,snuevomonto)  
	EndIf
	Call FreeODBCDLL ()
EndEvent

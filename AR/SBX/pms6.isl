...
Sub ProcessMealConsumption()
	...
	If(gbliConsumeQty > 0)
		...
		If 	(gblsCustomerClass = CUST_CLASS_DISCOUNT)
			...
			LoadKybdMacro Key(KEY_TYPE_MENU_ITEM, 900087), MakeKeys(gblsCustomerName), @KEY_ENTER
...
Sub ProcessMealConsumptionEspecial()
	...
	If(gbliConsumeQty > 0)
		...
		If 	(gblsCustomerClass = CUST_CLASS_DISCOUNT)
			LoadKybdMacro Key(KEY_TYPE_DISCOUNT, gbliDiscObjNum), MakeKeys(gblsCustomerName), @KEY_ENTER
			LoadKybdMacro Key(KEY_TYPE_MENU_ITEM, 900088), MakeKeys(gblsCustomerName), @KEY_ENTER
